	...
	public class Help
	{
		...
		public Help(XMLOutputWriter newxml)
		{
			...
			commandHelpHash.Add(Command.GET, new CommandHelpEntry(
				...
				new Option[] { Option.BACKUP, Option.DESTPATH, Option.MAKEWRITABLE, Option.MAKEREADONLY, Option.MERGE, Option.NOCLOAKS, Option.NORECURSIVE, Option.PERFORMDELETIONS, Option.SETFILETIME, Option.VERBOSE, Option.WORKINGFOLDER }
				));
			...
			commandHelpHash.Add(Command.GETVERSION, new CommandHelpEntry(
				...
				new Option[] { Option.BACKUP, Option.MAKEWRITABLE, Option.MAKEREADONLY, Option.MERGE, Option.NOCLOAKS, Option.NORECURSIVE, Option.SETFILETIME, Option.USEWORKINGFOLDER, Option.VERBOSE, }
				));
